...
각 섹션은 서로 다른 시간 척도를 가집니다. 섹션 2 는 한 번 적은 줄을 절대 지우지 않고 누적됩니다. 섹션 3 은 유동적이며 항목이 완료되면 섹션 2 로 옮기고 섹션 3 에서는 즉시 삭제합니다 (✅ 마커를 남기지 않음 — 누적 비용 회피). 섹션 4 는 큰 결정이 있을 때만 새 항목이 추가됩니다.
...
- 섹션 3 의 항목이 완료되면 → 섹션 2 의 해당 커밋 줄에 흡수하고 섹션 3 에서는 즉시 삭제. ✅ 마커는 남기지 않는다.
